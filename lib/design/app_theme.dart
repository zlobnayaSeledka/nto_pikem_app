...
class CustomAppTheme{
  static Color mainColor = const Color.fromARGB(255, 69, 60, 238);//Colors.limeAccent.shade400;
  static Color secondColor = const Color.fromARGB(255, 69, 60, 238); //const Color(0xffa6d2ff); //Color(0xff9cb7d4);
